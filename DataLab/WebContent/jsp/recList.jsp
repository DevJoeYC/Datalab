...
<div class="contents">
	    <div class="">
	    <div class="card">
		 	<h2>Community Chart</h2>
     
     <a href="commu.jsp?mode=Y">년도별 조회</a>
	 <a href="commu.jsp?mode=M">월별 조회</a>	
	...
	{
		%>
		<form id="myForm" name="myForm" method="get" action="commu.jsp">
	...
	%>
	 ...
	 <!--  <form id="chartForm" name="chartForm" method="get" action="commu.jsp">
		<input type="hidden" id="type" name="type" value="line">
		<table id="ChartType" border="1">
            <tr class="header"><td>차트타입</td></tr>
            <tr>
                <td>
                    <select id="type" name="type" onchange="document.chartForm.submit();">
	...
	<div id="wanted" style="width: 100%; height: 400px; margin: 0 auto"></div>
	<script>
